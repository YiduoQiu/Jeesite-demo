 ...
 */
package com.thinkgem.jeesite.modules.yhpc.entity;
 ...
 * @version 2018-08-09
 */
public class CzzYhpc extends DataEntity<CzzYhpc> {
	
	private static final long serialVersionUID = 1L;
	private String name;		// 隐患名称
	private String yhType;		// 隐患类型
	...
	@Length(min=0, max=1, message="隐患类型长度必须介于 0 和 1 之间")
