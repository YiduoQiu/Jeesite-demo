...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/aqkh/czzAqkh/">安全考核列表</a></li>
		<li class="active"><a href="${ctx}/aqkh/czzAqkh/form?id=${czzAqkh.id}">安全考核<shiro:hasPermission name="aqkh:czzAqkh:edit">${not empty czzAqkh.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="aqkh:czzAqkh:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="czzAqkh" action="${ctx}/aqkh/czzAqkh/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
