...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/aqgl_zrz/czzAqglZrz/">安全管理责任制列表</a></li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				<th>标题</th>
				<shiro:hasPermission name="aqgl_zrz:czzAqglZrz:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="czzAqglZrz">
			<tr>
				...
				<shiro:hasPermission name="aqgl_zrz:czzAqglZrz:edit"><td>
    				<a href="${ctx}/aqgl_zrz/czzAqglZrz/form?id=${czzAqglZrz.id}">修改</a>
