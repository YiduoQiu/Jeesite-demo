...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/aqtrzj/czzAqtrzj/">安全投入资金计划列表</a></li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>制定时间</th>
				<th>更新时间</th>
				<shiro:hasPermission name="aqtrzj:czzAqtrzj:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="czzAqtrzj">
			<tr>
				...
				<td>
					<fmt:formatDate value="${czzAqtrzj.date}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
					<fmt:formatDate value="${czzAqtrzj.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<shiro:hasPermission name="aqtrzj:czzAqtrzj:edit"><td>
    				<a href="${ctx}/aqtrzj/czzAqtrzj/form?id=${czzAqtrzj.id}">修改</a>
