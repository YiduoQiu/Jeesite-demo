...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/aqsc_czgc/czzAqglCzgc/form?id=${czzAqglCzgc.id}">安全生产操作规程<shiro:hasPermission name="aqsc_czgc:czzAqglCzgc:edit">${not empty czzAqglCzgc.id?'查看':'添加'}</shiro:hasPermission><shiro:lacksPermission name="aqsc_czgc:czzAqglCzgc:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<div id="view" class="form-horizontal">
		<div id="pagecontent">	
			<div class="control-group">
				<label class="control-label">标题：</label>
				<div style="padding-top: 3px;">${czzAqglCzgc.title}</div>
			</div>
			<div class="control-group">
				<label class="control-label">内容：</label>
				<div style="margin-left:160px;margin-right:10px;padding-top: 3px;">${czzAqglCzgc.content}</div>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="aqsc_czgc:czzAqglCzgc:edit"><input id="btnSubmit" class="btn btn-primary" type="button" onclick="switch_content()" value="修 改"/>&nbsp;</shiro:hasPermission>
			<input id="btnCancel" class="btn" type="button" value="返 回" onclick="history.go(-1)"/>
			<a class="btn jquery-word-export" href="javascript:void(0)">导出为word文档</a>
		</div>
	</div>
	<form:form id="inputForm" modelAttribute="czzAqglCzgc" action="${ctx}/aqsc_czgc/czzAqglCzgc/save" method="post" class="form-horizontal" style="display:none">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<a href="${ctx}/aqsc_czgc/czzAqglCzgc/help" target="_blank">安全生产操作规程模板</a>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">内容：</label>
