...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/aqjc/czzAqjc/">安全检查列表</a></li>
		<li class="active"><a href="${ctx}/aqjc/czzAqjc/form?id=${czzAqjc.id}">安全检查<shiro:hasPermission name="aqjc:czzAqjc:edit">${not empty czzAqjc.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="aqjc:czzAqjc:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="date" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${czzAqjc.date}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="deadline" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${czzAqjc.deadline}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
			</div>
		</div>
		<div class="control-group">
